...
const fields = ["status","wishlistType","brand","model","reference","movement","diameter","year","purchasePrice","currentValue","image","link","casePart","dialPart","handsPart","strapPart","notes"];

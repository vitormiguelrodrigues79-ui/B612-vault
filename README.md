...
## Alterações v3
- Wishlist aceita relógios específicos (marca + modelo) ou apenas marcas
- Modelo deixa de ser obrigatório na Wishlist
- Cartões redesenhados para iPhone em formato horizontal e compacto
- Formulário móvel passa a abrir como painel inferior
- Campos com 16 px para evitar zoom automático do Safari

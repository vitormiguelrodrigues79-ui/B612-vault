const CACHE='oud-haenir-teste-sensorial-v2';
const CORE=['./','./index.html','./manifest.webmanifest','./test-social.js','./sensory-theme.css','./sensory-layout.js','./sensorial-hero-day.webp','./sensorial-hero-night.webp'];

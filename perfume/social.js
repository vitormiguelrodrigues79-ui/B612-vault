...
function ensureFriends(){
  ...
  panel.innerHTML='<h3>Amigos</h3><p>Esta secção fica preparada para, numa fase seguinte, ligares outros utilizadores da app. Nesta versão ainda não altera a base de dados.</p>';
